  ...
  return (
    <>
        <div className=" z-10 top-0 right-0 w-full fixed h-full bg-[rgba(0,0,0,0.2)]">
            <div ref={cartref} className="w-fit py-7  bg-white ml-auto h-[746px]">
                ...
                </div>
                {
                  ...
                  :
                  <div className="h-[460px] px-6">
                    <p className="text-xl font-bold font-poppins text-center pt-10">There is no item in this cart!</p>
                  </div>
                }
