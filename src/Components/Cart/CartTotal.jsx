    ...
    <section className='py-[66px]'>
        <div className="container m-auto">
            <div className="flex justify-between gap-[30px]">
                ...
                <ul className='flex  justify-between gap-32 text-base text-black font-poppins font-semibold py-4 px-[144px] bg-[#F9F1E7]'>
                    <li><h3>Product</h3></li>
                    <li><h3>Price</h3></li>
                ...
                <div className="w-4/12 px-[75px] pt-4 pb-20 bg-[#F9F1E7]">
                    ...
                    <Link to={'#'} className='py-4 px-15 border-[1px] border-black rounded-[15px]' >Check Out</Link>
                    </div>
                </div>
